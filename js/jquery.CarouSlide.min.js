...
*/
(function($){$.fn.CarouSlide=function(userConfig){$.fn.CarouSlide.config={slideTime:5000,animTime:1000,autoAnim:false,animInfinity:false,alwaysNext:false,animType:"fade",showSlideNav:true,showBackNext:false,showPauseButton:false,sliderHolder:".rotator",navContainer:".slider-nav",hoverLinks:false,easingStyle:null};function methods(){this.props={};var $m=this;this.gotoSlide=function(pos,direct,dir){pos=parseInt(pos);if(pos!=$m.props.currentSlide){$m.props.animReady=false;$m.props.prevSlide=$m.props.currentSlide;$m.props.direction=dir;$m.props.direct=direct;$m.props.animQueue=null;$m.props.oldPos=$m.props.currentSlide;$m.props.newPos=null;if($m.props.direct){if($m.props.autoAnim&&$m.props.animState=="play"){$m.resetTimer();}
